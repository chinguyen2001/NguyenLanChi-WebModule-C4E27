...
app = Flask(__name__)
app.config["SECRET_KEY"] = "aishiteru"
...
def update(id):
    update_info = Services.find_one({"_id": ObjectId(id)})
    if request.method == "GET":
        return render_template('update-service.html', update_info=update_info)
        ...
        Services.update_one(update_info, new_value)
